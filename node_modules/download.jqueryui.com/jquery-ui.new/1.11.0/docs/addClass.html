...
<li class="signature">
<h4 class="name"><a id="addClass-className-options" href="#addClass-className-options"><span class="icon-link"></span>.addClass( className [, options ] )</a></h4>
<ul>
<li>
<div><strong>className</strong></div>
<div>Type: <a href="http://api.jquery.com/Types/#String">String</a>
